...
<Loading {loading}>
    <div class="flex flex-col w-full items-center pb-8 overflow-x-hidden">
        <div class="flex flex-col w-11/12">
            ...
            <span class="text-2xl font-bold min-w-fit my-2 flex flex-row items-center">
                <img
                        ...
                        <div class="flex flex-row lg:flex-col">
                            <div class="flex flex-row justify-between pt-4 pb-12 w-6xx md:w-auto 2xs:flex-col">
                                ...
                                <div class="flex flex-col 2xs:mt-8 justify-between">
                                    <a href={customerPortalUrl} class="bg-accent px-12 py-2 rounded-md text-center text-sm mb-1">Update Plan</a>
                                    <a href={customerPortalUrl} class="bg-light-primary px-12 py-2 rounded-md text-center text-sm mt-1">Cancel Plan</a>
                                </div>
                            </div>
