<script>
    ...
    $: user = {
        ...
        alerts: [
            {
                title: "Entry",
                description: `This is a description that goes on every alert\\n**Entry:** Entry\\n**Ticker:** AAPL\\n**Expire:** 10/12\\n**Comment:** Some comment\\n**Extra:** Some extra stuff\\nSpecial: Special stuff\\nNo title`,
                color: "#ff0000",
                date: 1650051214000,
            },
        ],
 ...
 <Loading {loading}>
    <div class="flex flex-col w-full items-center pb-8 overflow-x-hidden">
        <div class="flex flex-col w-11/12">
            <h1 class="my-16 lg:my-12">Account</h1>
                <div class="flex flex-row lg:flex-col-reverse lg:items-center w-full">
                    ...
                    <div class="flex flex-col lg:ml-0 w-full">
                        ...
                        <span class="font-bold mt-2">You can edit your bot in the discord <a href="/" class="primary-link">developer dashboard</a></span>
                    </div>
                </div>
            ...
            {/if}
            <span class="flex flex-col my-12">
                <span class="text-2xl font-bold min-w-fit">Alert History</span>
                <hr class="border-gray-400 border border-solid border-opacity-40 rounded-xl h-0 mt-4 w-full"/>
            </span>
            <div class="stats flex flex-row w-full justify-between 2xs:flex-col 2xs:items-center">
                <div class="stat">
